...
async def create_supertimeline(
    *,
    ...
    args = [
        "--storage-file", output_plaso,
        "--parsers", "win7,winevtx,mft,prefetch,registry,lnk,pe",
        "--hashers", "md5,sha256",
        evidence_path,
    ]
    try:
        ...
        return ForensicResult(tool="create_supertimeline", outcome=ToolOutcome.FAIL,
    ...
    return ForensicResult(
        tool="create_supertimeline", outcome=ToolOutcome.OK,
...
async def sort_timeline(
    *,
    ...
    try:
        ...
        return ForensicResult(tool="sort_timeline", outcome=ToolOutcome.FAIL,
                              summary=str(e), duration_ms=0, error=str(e))
    ...
    return ForensicResult(
        tool="sort_timeline", outcome=ToolOutcome.OK,
